...
from com_marl.torch.baselines import GaussianMLPBaseline # baseline
from com_marl.torch.policies import CentralizedCategoricalMLPPolicy # policy
...
def run(args):
    ...
    if args.mode == 'train':
        ...
        def train_coverage(ctxt=None, args_dict=vars(args)):
        ...
        train_coverage(args_dict=vars(args))
...
if __name__ == '__main__':
    ...
    # args.Den = 0.03
    #! Run by
    # python runner_co_cent.py --cmd train --map 10 --sen 1 --den 0.03 --loss 0
